...
```yaml
image: lowsabishi/qbittorrent-next-ui:v1.17.3-funky9
```

如果从 Docker Hub 拉取受限，可以把镜像地址换成 GHCR：

```yaml
image: ghcr.io/cainiao524/qbittorrent-next-ui:v1.17.3-funky9
```
