      ...
      <div className="sticky top-[var(--detail-tabs-offset)] z-20 before:pointer-events-none before:absolute before:inset-x-0 before:-top-4 before:h-4 before:bg-background before:content-['']">
        <div className="overflow-hidden rounded-t-2xl border-b border-muted/30 bg-background/95 shadow-md shadow-black/5 backdrop-blur-xl dark:shadow-black/25">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-muted/30 bg-muted/15 px-5 py-3 md:px-6">
            ...
            <div className="flex flex-1 flex-wrap items-center justify-end gap-2">
              ...
              <Button
                variant="ghost"
                size="sm"
                onClick={() => setExpanded(new Set(folderKeys))}
              >
                <ChevronsUpDown />
          ...
          {!isMobile && (
            ...
            >
              <div className="grid h-12 min-w-[850px] grid-cols-[44px_minmax(320px,1fr)_120px_minmax(180px,260px)_150px] items-center border-b border-muted/30 bg-muted/30 text-[10px] font-medium uppercase tracking-widest text-muted-foreground md:min-w-0 md:text-xs">
              ...
              >
                {renderedNodes.map(({ node, depth }) => {
                  ...
                  return (
                    <div
                      key={node.key}
                      className="group grid h-14 grid-cols-[44px_minmax(320px,1fr)_120px_minmax(180px,260px)_150px] items-center border-b border-muted/30 transition-colors hover:bg-muted/25"
                    >
                      <div className="flex items-center justify-center">
                        <Checkbox
                      ...
                      <div
                        className="flex min-w-0 items-center gap-2.5 pr-4 font-medium"
